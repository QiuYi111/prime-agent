...
export const MODELS = {
	...
	"dashscope": {
		"qwen3.7-flash": {
			...
			compat: {"supportsDeveloperRole":false,"maxTokensField":"max_completion_tokens","thinkingFormat":"qwen"},
			reasoning: true,
			input: ["text", "image"],
			cost: {
				input: 0,
		...
		"qwen3.8-max": {
			...
			provider: "dashscope",
			baseUrl: "https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1",
			compat: {"supportsDeveloperRole":false,"maxTokensField":"max_completion_tokens","thinkingFormat":"qwen","supportsReasoningEffort":true,"preserveThinking":true,"requiresReasoningContentOnAssistantMessages":true},
			reasoning: true,
			thinkingLevelMap: {"off":"off","minimal":"low","low":"low","medium":"medium","high":"medium","xhigh":"xhigh","max":"xhigh"},
			input: ["text", "image"],
			cost: {
				input: 0,
				output: 0,
	...
	"zai": {
		"glm-5.3-flash": {
			...
			compat: {"supportsDeveloperRole":false,"supportsReasoningEffort":true,"thinkingFormat":"zai-preserved","zaiToolStream":true},
			reasoning: true,
			thinkingLevelMap: {"off":null,"minimal":null,"low":"low","medium":"medium","high":"high","xhigh":"xhigh","max":"max"},
			input: ["text", "image"],
			cost: {
